...
class Graph:
    def __init__(self, base_stations, clients, xlim, map_limits,
        ...
        self.gs = gridspec.GridSpec(4, 4, width_ratios=[6, 3, 3, 3], height_ratios=[3, 3, 3, 3])
    ...
    def draw_stats(self, vals, vals1, vals2, vals3, vals4, vals5, vals6, vals7, vals8):
        ...
        self.ax2 = plt.subplot(self.gs[2, 2])
        self.ax2.plot(vals8)
        self.ax2.set_xlim(self.xlim)
        self.ax2.set_xticks(locs)
        self.ax2.yaxis.set_major_formatter(FormatStrFormatter('%3.1f ms'))
        self.ax2.use_sticky_edges = False
        self.ax2.set_title('Latency')
        ...
        self.ax7 = plt.subplot(self.gs[3, 2])
        self.ax7.plot(vals6)
        ...
        cell_text = [
            ...
            [f'{format_bps(mean(vals7[l:r]), return_float=True)}'],
            ['%3.1f ms' % mean(vals8[l:r])],
            [f'{mean(vals2[l:r]):.2f}'],
            [f'{mean(vals4[l:r]):.2f}'],
            [f'{mean(vals5[l:r]):.4f}'],
            [f'{mean(vals6[l:r]):.4f}'],
