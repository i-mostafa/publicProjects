(function() {
  ...
  */
        ...
        6: [
            ...
            { "../utils": 18, "./base": 5, "bn.js": 2, inherits: 33 }
        ],
        7: [
            function(require, module, exports) {
                "use strict";
        ...
        10: [
            ...
            { "./curve": 7, "./precomputed/secp256k1": 17, "./utils": 18, "hash.js": 20 }
        ],
        11: [
            function(require, module, exports) {
                "use strict";
            ...
            { "../curves": 10, "../utils": 18, "./key": 12, "./signature": 13, "bn.js": 2, brorand: 3, "hmac-drbg": 32 }
        ],
        12: [
            function(require, module, exports) {
                "use strict";
        ...
        14: [
            ...
            { "../curves": 10, "../utils": 18, "./key": 15, "./signature": 16, "hash.js": 20 }
        ],
        15: [
            function(require, module, exports) {
                "use strict";
        ...
        18: [
            ...
            { "bn.js": 2, "minimalistic-assert": 34, "minimalistic-crypto-utils": 35 }
        ],
        19: [
            function(require, module, exports) {
                module.exports = {
                    ...
                    _spec: "elliptic",
                    _where: "D:\\courses\\workspace\\Projects\\blockChainJS",
                    author: {
                        name: "Fedor Indutny",
        ...
        20: [
            ...
            { "./hash/common": 21, "./hash/hmac": 22, "./hash/ripemd": 23, "./hash/sha": 24, "./hash/utils": 31 }
        ],
        21: [
            function(require, module, exports) {
                "use strict";
        ...
        24: [
            ...
            { "./sha/1": 25, "./sha/224": 26, "./sha/256": 27, "./sha/384": 28, "./sha/512": 29 }
        ],
        25: [
            function(require, module, exports) {
                "use strict";
        ...
        27: [
            ...
            { "../common": 21, "../utils": 31, "./common": 30, "minimalistic-assert": 34 }
        ],
        28: [
            function(require, module, exports) {
                "use strict";
        ...
        32: [
            ...
            { "hash.js": 20, "minimalistic-assert": 34, "minimalistic-crypto-utils": 35 }
        ],
        33: [
            function(require, module, exports) {
...
class Transaction {
    constructor(fromAddress, toAddress, amount, loginUserName) {
    ...
    calculateHash() {
        return SHA256(this.fromAddress + this.toAddress + this.amount + this.loginUserName).toString();
    }
...
class BlockChain {
    ...
    minePendingTransactions(miningRewardAddress) {
        let glopalPreviousHash = JSON.parse(localStorage.getItem("previousHash"));
        let block = new Block(Date.now(), this.pendingTransactions, glopalPreviousHash);
...
const adminKey = ec.keyFromPrivate("superUser");
const adminWallettAddress = adminKey.getPublic("hex");

function generateBlock() {
    addAllTransactions();
    ebsVisa.minePendingTransactions(adminWallettAddress);
    location.reload(true);
}

function getBalance(loginUserName) {
    const Key = ec.keyFromPrivate(loginUserName);
    const WallettAddress = Key.getPublic("hex");
    return ebsVisa.getBalanceAddress(WallettAddress);
}

function payTransaction(loginUserName, amount) {
    const Key = ec.keyFromPrivate(loginUserName);
    const WallettAddress = Key.getPublic("hex");
    const tx = new Transaction(WallettAddress, adminWallettAddress, amount, loginUserName);
    tx.signTransaction(Key);
    addTransToDB(tx);
    ebsVisa.addTransaction(tx);
}

function addBlockToDB(block) {
    let data = JSON.parse(localStorage.getItem("Blocks"));
    let blockNumber = data.length() - 1;
    //console.log(blockNumber);
    data[blockNumber] = block;
    localStorage.setItem("previousHash", JSON.stringify(block.hash));
    data = JSON.stringify(data);
    localStorage.setItem("Blocks", data);
}
function addTransToDB(transaction) {
    let data = JSON.parse(localStorage.getItem("transactions"));
    let transNumber = data.length() - 1;
    //console.log(blockNumber);
    data[transNumber] = transaction;
    data = JSON.stringify(data);
...
function addAllTransactions() {
    ebsVisa.pendingTransactions = [];
    let data = JSON.parse(localStorage.getItem("transactions"));
    for (let i = 0; i < data.length() - 1; i++) {
        payTransaction(data[i].loginUserName, data[i].amount);
    }
