...
function changePassword() {
    let currentPass = document.getElementById("password");
    let newPassword = document.getElementById("newPassword");
    if (JSON.parse(localStorage.getItem(localStorage.login)).password == currentPass.value) {
        editData(localStorage.login, "password", newPassword.value);
        window.location.href = "./home.html";
    } else {
        console.log(currentPass.value, JSON.parse(localStorage.getItem(localStorage.login)).password);
        alert("wrong password");
    }
}
